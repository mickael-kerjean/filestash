...
<ul>
    ...
    <li>... and much <sub>much <sub>more (chromecast suport, on demand video transcoding, mounting share links as network drive, public site, antivirus, versioning, audit, quota, ....)</sub></sub> As a rule of thumb, if your problem can be solve with something involving files, we most likely have a plugin for it</li>
