...
<ul>
    ...
    <li>Workflow engine: automate anything that happens to your files by chaining actions on events, from Slack notifications and email alerts to MFT pipelines and compliance verification.</li>
