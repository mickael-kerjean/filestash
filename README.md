...
<ul>
    ...
    <li>Workflow engine: automate anything that happens to your files by chaining actions on events, from simple Slack notifications and email alerts to full on MFT pipelines.</li>
