...
extern "C" {
    ...
    pub fn req_url_query(key_ptr: *const u8, key_len: u32, out_ptr: *mut u8, out_cap: u32) -> u32;
    ...
    pub fn app_body(out_ptr: *mut u8, out_cap: u32) -> u32;
    pub fn app_session(out_ptr: *mut u8, out_cap: u32) -> u32;
