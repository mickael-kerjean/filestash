...
class Shp {
    constructor (options) {
      ...
      if (this._options.arraybuffers) {
        ...
        this._tableBuffer = this._options.arraybuffers.dbfBuffer ? buffer.Buffer.from(this._options.arraybuffers.dbfBuffer) : null;
        this._projString = this._options.arraybuffers.projString ? buffer.Buffer.from(this._options.arraybuffers.projString) : null;
        this._init();
      }
    }
