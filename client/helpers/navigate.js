...
export function goToHome(history) {
    history.push(window.sub_folder + URL_HOME);
    return Promise.resolve("ok");
}

export const URL_FILES = "/files";
export function goToFiles(history, path, state) {
    history.push(window.sub_folder + URL_FILES+"?path="+encode_path(path), state);
    return Promise.resolve("ok");
}
...
export function goToViewer(history, path, state) {
    history.push(window.sub_folder + URL_VIEWER+"?path="+encode_path(path), state);
    return Promise.resolve("ok");
}

export const URL_LOGIN = "/login";
export function goToLogin(history) {
    history.push(window.sub_folder + URL_EDIT);
    return Promise.resolve("ok");
}

export const URL_LOGOUT = "/logout";
export function goToLogout(history) {
    history.push(window.sub_folder + URL_LOGOUT);
    return Promise.resolve("ok");
}
